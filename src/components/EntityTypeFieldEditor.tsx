  ...
  return (
    <fieldset>
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 4 }} container sx={{ alignItems: 'flex-start', justifyContent: 'space-around' }}>
          <FormControlLabel
            label="Queryable"
            control={
              <Checkbox
        ...
        {isNested ? (
          ...
          <>
            ...
            <Grid size={{ xs: 2 }} container sx={{ alignItems: 'flex-start', justifyContent: 'space-around' }}>
              <FormControlLabel
                label="Is ID column"
                control={
                  <Checkbox
        ...
        {useMemo(
          ...
          [field, entityType, parentName, onChange],
        )}
        ...
        {useMemo(
          ...
          [field, onChange, parentName, entityTypes],
        )}
                ...
                <fieldset>
                  ...
                  {field.values.map((value, i) => (
                    <Grid container spacing={2} sx={{ mb: 1 }} key={i}>
                      ...
                      <Grid size={{ xs: 1 }} container sx={{ justifyContent: 'flex-end' }}>
                        <IconButton
                          onClick={() =>
                            onChange({
                              ...field,
        ...
        {useMemo(
          () => (
            <>
              <Grid size={{ xs: 2 }} sx={{ fontFamily: 'monospace' }}>
                valueGetter
              </Grid>
          ...
          [codeMirrorExtension, field, onChange],
        )}
